 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $S="firebase-heartbeat-database",US=1,Ri="firebase-heartbeat-store";let za=null;function Qm(){return za||(za=rS($S,US,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Ri)}}}).catch(e=>{throw Xt.create("idb-open",{originalErrorMessage:e.message})})),za}async function zS(e){try{return await(await Qm()).transaction(Ri).objectStore(Ri).get(Ym(e))}catch(t){if(t instanceof rn)Rn.warn(t.message);else{const n=Xt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Rn.warn(n.message)}}}async function af(e,t){try{const r=(await Qm()).transaction(Ri,"readwrite");await r.objectStore(Ri).put(t,Ym(e)),await r.done}catch(n){if(n instanceof rn)Rn.warn(n.message);else{const r=Xt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Rn.warn(r.message)}}}function Ym(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ir(KS,qS,"app");function Xm(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const QS=Xm,Jm=new Ui("auth","Firebase",Xm());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ms=new Wm("@firebase/auth");function YS(e,...t){ms.logLevel<=F.WARN&&ms.warn(`Auth (${Fi}): ${e}`,...t)}function Lo(e,...t){ms.logLevel<=F.ERROR&&ms.error(`Auth (${Fi}): ${e}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ig(){return typeof ut().WorkerGlobalScope<"u"&&typeof ut().importScripts=="function"}async function Q_(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Y_(){var e;return((e=navigator==null?void 0:navigator.serviceWorker)===null||e===void 0?void 0:e.controller)||null}function X_(){return Ig()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QE=5*60,YE=Hm("authIdTokenMaxAge")||QE;let Tf=null;const XE=e=>async t=>{const n=t&&await t.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>YE)return;const i=n==null?void 0:n.token;Tf!==i&&(Tf=i,await fetch(e,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function JE(e=jS()){const t=Km(e,"auth");if(t.isInitialized())return t.getImmediate();const n=I_(e,{popupRedirectResolver:VE,persistence:[rE,V_,kg]}),r=Hm("authTokenSyncURL");if(r){const o=XE(r);F_(n,o,()=>o(n.currentUser)),z_(n,s=>o(s))}const i=Tw("auth");return i&&T_(n,`http://${i}`),n}qE("Browser");const ZE={apiKey:"AIzaSyCZhqLRgqG2MWJf6N4hjSXwTmBt9gHHTxc",authDomain:"iqra-372fd.firebaseapp.com",projectId:"iqra-372fd",storageBucket:"iqra-372fd.appspot.com",messagingSenderId:"942368873108",appId:"1:942368873108:web:eace8c2ae8932ed715f281",measurementId:"G-JSH95EFSZT"},ek=qm(ZE),Og=new Ae,Er=JE(ek),tk=A.div`
    display: flex;
...
`,wI=A.div`
    ...
    gap: 1rem;
    flex-grow: 0.05;
`;function SI(){const e=ji(),t=()=>{e("iqra-client/sign-up")},n=()=>{e("iqra-client/sign-in")};return C.jsxs(pI,{children:[C.jsx(mI,{children:C.jsx(Mg,{})}),C.jsx(gI,{children:"The free, fun, and effective way to learn Arabic!"}),C.jsxs(wI,{children:[C.jsx(yI,{onClick:t,children:"Get started"}),C.jsx(vI,{onClick:n,children:"I already have an account"})]})]})}var qg={exports:{}},_I="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",EI=_I,kI=EI;function Qg(){}function Yg(){}Yg.resetWarningCache=Qg;var II=function(){function e(r,i,o,s,a,l){if(l!==kI){var u=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw u.name="Invariant Violation",u}}e.isRequired=e;function t(){return e}var n={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:Yg,resetWarningCache:Qg};return n.PropTypes=n,n};qg.exports=II();var CI=qg.exports;const cu=Hf(CI),TI=A.div`
    height: 100vh;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`,Jg=({children:e})=>{const[t,n]=I.useState(null);return I.useEffect(()=>{const r=Er.onAuthStateChanged(i=>{n(i||null)});return()=>r()},[]),C.jsx(bg.Provider,{value:t,children:e})};Jg.propTypes={children:cu.node.isRequired};function QI(){return C.jsx(Jg,{children:C.jsxs(g1,{children:[C.jsx(qI,{}),C.jsxs(p1,{children:[C.jsx(dn,{path:"iqra-client/",element:C.jsx(SI,{})}),C.jsx(dn,{path:"iqra-client/sign-in",element:C.jsx(fk,{})}),C.jsx(dn,{path:"iqra-client/sign-up",element:C.jsx(kk,{})}),C.jsx(dn,{path:"iqra-client/listening",element:C.jsx(LI,{})}),C.jsx(dn,{path:"iqra-client/dashboard",element:C.jsx(Pk,{})}),C.jsx(dn,{path:"*",element:C.jsx(hI,{})})]})]})})}qa.createRoot(document.getElementById("root")).render(C.jsx(Xe.StrictMode,{children:C.jsx(QI,{})}));
